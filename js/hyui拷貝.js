$(function() {
  ...
  _menu2.find('li').keyup(function() {
    $(this).siblings().children('ul').hide();
  });
  _menu2.find('li:last>a').focusout(function() {
    _menu2.find('li ul').hide();
  });
  ...
  function menuToggle() {
    if (!menu_mode) {
      _menu1.stop(true, false).slideDown('400', 'easeOutQuint');
  ...
  _menuSwitch.off().on('click', function(e) {
    menuToggle();
    e.preventDefault();
  });
  _menuSwitch.click(function(e) {
    _menu1.slideDown();
    e.stopPropagation();
  });
  _menu1.find('.close').focusout(function(e) {
    _menu1.hide();
    _body.removeClass('noscroll');
    e.preventDefault();
  });
  _menu1.find('.close').click(function(e) {
    _menu1.hide();
    e.preventDefault();
  });
